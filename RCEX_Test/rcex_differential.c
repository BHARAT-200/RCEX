// THIS WILL FAIL BECUASE RCEX IS A STREAM CIPHER
...
int main()
{
    ...
    int8 plaintext1[PLAINTEXT_SIZE];
    int8 plaintext2[PLAINTEXT_SIZE];


    printf("\n");
    printf("=====================================\n");
    printf("     RCEX DIFFERENTIAL TEST\n");
    printf("=====================================\n");
    ...
    for(int t = 0; t < TRIALS; t++)
    {
        ...
        random_bytes(plaintext1, PLAINTEXT_SIZE);
        ...
        // Flip exactly one plaintext bit

        int byte = rand() % PLAINTEXT_SIZE;
        int bit = rand() % 8;

        plaintext2[byte] ^= (1 << bit);
